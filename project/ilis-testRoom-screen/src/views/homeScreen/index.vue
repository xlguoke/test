  ...
  <div class="screen-warp">
    ...
    <div class="body-warp">
      ...
      <div class="flex-box pd-x">
        ...
        <div class="s-card s-card-flex">
          <div class="s-card-head font-ys" style="padding-left: 50px">当日在检任务</div>
          <div class="s-card-body">
            <ul class="task-list">
              <li class="tr thead">
                <!-- <p class="order">序号</p> -->
        ...
        <div class="s-card">
          <div class="s-card-head font-ys">功能室使用情况</div>
          <div class="s-card-body">
  ...
  .body-warp {
    ...
    .statistics {
      ...
      .statistics-item {
        ...
        &.three {
          width: 5.4rem;
          border-color: rgba(255, 88, 88, 0.39);
          color: #ff5858;
          box-shadow: inset 0 0 0.5rem rgba(255, 88, 88, 0.3);
          .title {
            color: #ff8383;
          }
          .linear-line(#ff5858);
