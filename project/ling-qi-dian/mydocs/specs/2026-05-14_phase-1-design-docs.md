...
- In:
  ...
  - **会员体系设计文档（`mydocs/member-system-design.md`）**：
    - 会员等级体系（7级定义：见习/青铜/白银/黄金/铂金/钻石/至尊）
    - 各等级权益明细（折扣率、积分倍率、生日礼、机车特色权益：洗车/保养/救援/备用车）
    - 升级规则（成长值门槛：100/1,000/3,000/8,000/15,000/30,000/50,000）
    - 等级权益续期机制（12个月内获得成长值续期，未达标权益降级）
    - 会员充值规则（3个档位：¥98/¥980/¥2,980，统一赠送余额10%，同时赠送成长值和积分）
    - 成长值与积分规则（成长值用于等级永不过期、积分用于抵扣12个月有效期，余额消费不给成长值和积分）
