...
- In:
  ...
  - **uni-app 点单端（`packages/app/src/pages/`）**：10 个页面（全平台通用）
    ...
    | `/member/index` | 会员中心 | 头像/昵称/等级/积分/余额/累计消费、会员码、福利入口、充值入口、升级进度、续期进度 |
    | `/member/benefits` | 会员福利 | 等级权益说明、升级规则、等级对比表（7级：见习/青铜/白银/黄金/铂金/钻石/至尊）、机车特色权益（洗车/保养/救援/备用车） |
    | `/member/recharge` | 会员充值 | 3个档位选择（¥98/¥980/¥2,980）、赠送金额/成长值/积分展示 |
