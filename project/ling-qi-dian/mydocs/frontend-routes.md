...
| 7 | `/pages/member/recharge` | 充值中心 | 充值档位、支付 |
| 8 | `/pages/member/points` | 积分明细 | 积分流水 |
| 9 | `/pages/member/records` | 充值记录 | 充值历史 |
| 10 | `/pages/cashier/index` | 收银台 | 店员收银（可选） |
...
| API | 用途 |
|:---|:---|
| `member-recharge-tiers` | 获取充值档位 |
| `member-recharge` | 发起充值 |

**页面状态**
```typescript
interface RechargeState {
  tiers: RechargeTier[]          // 充值档位
...
| `/pages/member/recharge` | `member-recharge-tiers`, `member-recharge` |
