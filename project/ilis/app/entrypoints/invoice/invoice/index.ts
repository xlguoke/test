...
import Main from '~/views/invoice/invoice/App/index.vue'
import router from '~/views/invoice/invoice/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#invoice')
