...
import Main from '~/views/dataCollection/datagather/reportingDataCollection/App/index.vue'
import router from '~/views/dataCollection/datagather/reportingDataCollection/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#reportingDataCollection')

  if (!el) {
    console.warn('#reportingDataCollection not found')
    return
  }
  ...
  app.mount('#reportingDataCollection')
})()
