...
import Main from '~/views/dataCollection/datagather/mechanicsDataCollection/App/index.vue'
import router from '~/views/dataCollection/datagather/mechanicsDataCollection/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#mechanicsDataCollection')

  if (!el) {
    console.warn('#mechanicsDataCollection not found')
    return
  }
  ...
  app.mount('#mechanicsDataCollection')
})()
