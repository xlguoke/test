...
import Main from '~/views/equipmentNew/scrap/equipScrap/App/index.vue'
import router from '~/views/equipmentNew/scrap/equipScrap/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipScrap')

  if (!el) {
    console.warn('#equipScrap not found')
    return
  }
