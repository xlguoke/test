...
import Main from '~/views/equipmentNew/startstop/equipStartStop/App/index.vue'
import router from '~/views/equipmentNew/startstop/equipStartStop/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipStartStop')

  if (!el) {
    console.warn('#equipStartStop not found')
    return
  }
