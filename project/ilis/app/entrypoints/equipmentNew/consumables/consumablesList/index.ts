...
import Main from '~/views/equipmentNew/consumables/consumablesList/App/index.vue'
import router from '~/views/equipmentNew/consumables/consumablesList/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#consumablesList')

  if (!el) {
    console.warn('#consumablesList not found')
    return
  }
