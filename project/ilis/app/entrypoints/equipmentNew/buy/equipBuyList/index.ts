...
import Main from '~/views/equipmentNew/buy/equipBuyList/App/index.vue'
import router from '~/views/equipmentNew/buy/equipBuyList/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipBuyList')

  if (!el) {
    console.warn('#equipBuyList not found')
    return
  }
