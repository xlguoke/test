...
import Main from '~/views/equipmentNew/buy/equipBuyPlanList/App/index.vue'
import router from '~/views/equipmentNew/buy/equipBuyPlanList/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipBuyPlanList')

  if (!el) {
    console.warn('#equipBuyPlanList not found')
    return
  }
