...
import Main from '~/views/equipmentNew/buy/equipBuyApplyList/App/index.vue'
import router from '~/views/equipmentNew/buy/equipBuyApplyList/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipBuyApplyList')

  if (!el) {
    console.warn('#equipBuyApplyList not found')
    return
  }
