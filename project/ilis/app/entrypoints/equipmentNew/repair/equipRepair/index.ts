...
import Main from '~/views/equipmentNew/repair/equipRepair/App/index.vue'
import router from '~/views/equipmentNew/repair/equipRepair/router/index'
import '~/main.ts'
...
(async function () {
  const el = document.querySelector<HTMLElement>('#equipRepair')

  if (!el) {
    console.warn('#equipRepair not found')
    return
  }
