...
import Main from '~/views/reportManageNew/question/reportQuestion/App/index.vue'
import router from '~/views/reportManageNew/question/reportQuestion/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#reportQuestion')

  if (!el) {
    console.warn('#reportQuestion not found')
    return
  }
