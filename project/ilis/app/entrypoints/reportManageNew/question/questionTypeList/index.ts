...
import Main from '~/views/reportManageNew/question/questionTypeList/App/index.vue'
import router from '~/views/reportManageNew/question/questionTypeList/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#questionTypeList')

  if (!el) {
    console.warn('#questionTypeList not found')
    return
  }
