...
import Main from '~/views/testbusiness/statistics/consignCollectionStatistic/App/index.vue'
import router from '~/views/testbusiness/statistics/consignCollectionStatistic/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#consignCollectionStatistic')

  if (!el) {
    console.warn('#consignCollectionStatistic not found')
    return
  }
  ...
  app.mount('#consignCollectionStatistic')
})()
