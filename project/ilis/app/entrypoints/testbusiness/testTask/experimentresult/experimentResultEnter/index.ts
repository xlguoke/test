...
import Main from '~/views/testbusiness/testTask/experimentresult/experimentResultEnter/App/index.vue'
import router from '~/views/testbusiness/testTask/experimentresult/experimentResultEnter/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#experimentResultEnter')

  if (!el) {
    console.warn('#experimentResultEnter not found')
    return
  }
  ...
  app.mount('#experimentResultEnter')
})()
