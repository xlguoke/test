...
import Main from '~/views/testbusiness/testTask/statistical/testParameterStatistic/App/index.vue'
import router from '~/views/testbusiness/testTask/statistical/testParameterStatistic/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#testParameterStatistic')

  if (!el) {
    console.warn('#testParameterStatistic not found')
    return
  }
  ...
  app.mount('#testParameterStatistic')
})()
