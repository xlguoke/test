...
import Main from '~/views/testbusiness/consign/editSample_SelectSample/App/index.vue'
import router from '~/views/testbusiness/consign/editSample_SelectSample/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#editSample_SelectSample')

  if (!el) {
    console.warn('#editSample_SelectSample not found')
    return
  }
  ...
  app.mount('#editSample_SelectSample')
})()
