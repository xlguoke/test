...
import Main from '~/views/common/databaseUpdate/App/index.vue'
import router from '~/views/common/databaseUpdate/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#databaseUpdate')

  if (!el) {
    console.warn('#databaseUpdate not found')
    return
  }
