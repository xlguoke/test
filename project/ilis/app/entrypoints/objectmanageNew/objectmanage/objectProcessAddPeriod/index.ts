...
import Main from '~/views/objectmanageNew/objectmanage/objectProcessAddPeriod/App/index.vue'
import router from '~/views/objectmanageNew/objectmanage/objectProcessAddPeriod/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#objectProcessAddPeriod')

  if (!el) {
    console.warn('#objectProcessAddPeriod not found')
    return
  }
  ...
  app.mount('#objectProcessAddPeriod')
})()
