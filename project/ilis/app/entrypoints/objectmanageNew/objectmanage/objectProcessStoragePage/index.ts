...
import Main from '~/views/objectmanageNew/objectmanage/objectProcessStoragePage/App/index.vue'
import router from '~/views/objectmanageNew/objectmanage/objectProcessStoragePage/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#objectProcessStoragePage')

  if (!el) {
    console.warn('#objectProcessStoragePage not found')
    return
  }
  ...
  app.mount('#objectProcessStoragePage')
})()
