...
import Main from '~/views/inspection/category/category/App/index.vue'
import router from '~/views/inspection/category/category/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#category')
