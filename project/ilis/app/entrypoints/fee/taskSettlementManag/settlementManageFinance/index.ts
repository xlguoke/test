...
import Main from '~/views/fee/taskSettlementManag/settlementManageFinance/App/index.vue'
import router from '~/views/fee/taskSettlementManag/settlementManageFinance/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#settlementManageFinance')

  if (!el) {
    console.warn('#settlementManageFinance not found')
    return
  }
  ...
  app.mount('#settlementManageFinance')
})()
