...
import Main from '~/views/fee/contract/contractreport/report/App/index.vue'
import router from '~/views/fee/contract/contractreport/report/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#report')
