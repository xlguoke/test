...
import Main from '~/views/chemicalManage/chemicalApplianceManage/App/index.vue'
import router from '~/views/chemicalManage/chemicalApplianceManage/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#chemicalApplianceManage')

  if (!el) {
    console.warn('#chemicalApplianceManage not found')
    return
  }
  ...
  app.mount('#chemicalApplianceManage')
})()
