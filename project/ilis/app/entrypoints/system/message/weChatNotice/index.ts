...
import Main from '~/views/system/message/weChatNotice/App/index.vue'
import router from '~/views/system/message/weChatNotice/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#weChatNotice')

  if (!el) {
    console.warn('#weChatNotice not found')
    return
  }
