...
import Main from '~/views/system/paramsType/parameterCategoryManage/App/index.vue'
import router from '~/views/system/paramsType/parameterCategoryManage/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#parameterCategoryManage')

  if (!el) {
    console.warn('#parameterCategoryManage not found')
    return
  }
  ...
  app.mount('#parameterCategoryManage')
})()
