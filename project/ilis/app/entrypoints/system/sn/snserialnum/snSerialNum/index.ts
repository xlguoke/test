...
import Main from '~/views/system/sn/snserialnum/snSerialNum/App/index.vue'
import router from '~/views/system/sn/snserialnum/snSerialNum/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#snSerialNum')

  if (!el) {
    console.warn('#snSerialNum not found')
    return
  }
