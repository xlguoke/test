...
import Main from '~/views/system/subcontract/subcontractDetail/App/index.vue'
import router from '~/views/system/subcontract/subcontractDetail/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#subcontractDetail')

  if (!el) {
    console.warn('#subcontractDetail not found')
    return
  }
