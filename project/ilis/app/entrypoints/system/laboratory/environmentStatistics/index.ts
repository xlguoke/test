...
import Main from '~/views/system/laboratory/environmentStatistics/App/index.vue'
import router from '~/views/system/laboratory/environmentStatistics/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#environmentStatistics')

  if (!el) {
    console.warn('#environmentStatistics not found')
    return
  }
  ...
  app.mount('#environmentStatistics')
})()
