...
import Main from '~/views/system/cloudTerraceMenuManage/cloudTerraceMenuManage/App/index.vue'
import router from '~/views/system/cloudTerraceMenuManage/cloudTerraceMenuManage/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#cloudTerraceMenuManage')

  if (!el) {
    console.warn('#cloudTerraceMenuManage not found')
    return
  }
  ...
  app.mount('#cloudTerraceMenuManage')
})()
