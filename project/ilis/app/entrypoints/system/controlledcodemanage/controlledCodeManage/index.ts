...
import Main from '~/views/system/controlledcodemanage/controlledCodeManage/App/index.vue'
import router from '~/views/system/controlledcodemanage/controlledCodeManage/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#controlledCodeManage')

  if (!el) {
    console.warn('#controlledCodeManage not found')
    return
  }
  ...
  app.mount('#controlledCodeManage')
})()
