...
import Main from '~/views/system/alternativelib/conclusionRemarksList/App/index.vue'
import router from '~/views/system/alternativelib/conclusionRemarksList/router/index'
import '~/main.ts'
import '~/providers/transformUtils/transform.less';

(async function () {
  const el = document.querySelector<HTMLElement>('#conclusionRemarksList')

  if (!el) {
    console.warn('#conclusionRemarksList not found')
    return
  }
  ...
  app.mount('#conclusionRemarksList')
})()
