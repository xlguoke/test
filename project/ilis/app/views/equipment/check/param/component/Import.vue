<template>
  ...
  >
    ...
    <div class=" mb-4">
      ...
      <div>1、下载检校参数导入模板，<span class="text-colorPrimary cursor-pointer" @click="downloadTemplate">点击下载</span></div>
...
async function handleUpload(option: UploadRequestOption) {
  sseRequestProgress.show({
    api: 'rest/equipmentNewController?importCheckItem',
    method: 'postForm',
    data: {
      file: option.file,
    },
