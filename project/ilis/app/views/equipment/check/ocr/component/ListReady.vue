...
import AddByDevice from '../../confirmList/components/AddByDevice.vue'
import { deleteOcr, getOcrPage } from '../api'
import { CheckStatusDict, columnsListReady as columns, handleCheckAnalysis, OcrQueryType, OrderType } from '../index'
...
const {
  ...
  formRef,
  query: formState,
  payload: { queryType: OcrQueryType.CONFIRMED },
  totalKey: 'count',
})
...
async function handleCheckDetail(_q: OcrRecordEntity) {
  ...
  AnyDialogHelper.showModel(AddByDevice, { isReadonly: true, id: _q.eqCheckId })
}
