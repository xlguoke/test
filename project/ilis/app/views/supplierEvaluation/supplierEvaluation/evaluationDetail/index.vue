        ...
        <a-form v-show="tabActiveKey == '1'" ref="formRef" style="width: 100%">
          <a-collapse v-model:active-key="activeKey">
            <a-collapse-panel key="1" header="供应商信息">
              <ul class="form_wrap">
                ...
                <li>
                  ...
                  >
                    <a-input
                      :value="selSupplierVal && selSupplierVal.type ? dictionaryEnum[selSupplierVal.type] : ''"
                      :disabled="true"
                    />
                  </a-form-item>
                </li>
            ...
            <a-collapse-panel key="2" header="评价内容">
              <template v-for="it in evaluationFieldConfig" :key="it.id">
                <a-form-item
                  v-if="it.status == 10"
                ...
                >
                  ...
                  <a-radio-group
                    ...
                    :disabled="isDetail"
                  >
                    <a-radio v-for="cit in it.candidateValue" :key="cit" :value="cit">
                      {{ cit }}
                    </a-radio>
                  </a-radio-group>
                  ...
                  <a-checkbox-group
                    ...
                    :disabled="isDetail"
                  >
                    <a-checkbox v-for="cit in it.candidateValue" :key="cit" :value="cit">
                      {{ cit }}
                    </a-checkbox>
                  </a-checkbox-group>
                </a-form-item>
...
export default {
  ...
  created() {
    ...
    this.openModel(getQueryVariable('id'), true)
    // this.openModel("4028b2298b4bc413018b4c03ebdc008e", true);
  },
  methods: {
    openEqList() {
      const acceptData = []
