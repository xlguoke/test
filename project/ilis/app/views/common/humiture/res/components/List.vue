<template>
  <div class="flex flex-col" style="height: calc(100% + 16px)">
    <a-space>
      <a-input v-model:value.trim="queryForm.quickQry" style="width: 240px;" placeholder="请输入预约人员/样品名称/任务编号" />
      <a-select
...
import { getHumitureResList, HumitureResListParams } from '~/views/common/humiture/res/api/getHumitureResList.ts'
