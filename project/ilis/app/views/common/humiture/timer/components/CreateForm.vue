<template>
  ...
  >
    ...
    >
      ...
      <a-form-item label="定时类型" name="restType" :rules="[{ required: true, message: '请选择重复类型！' }]">
...
import { createHumitureTimer, CreateTimerSettingEntity } from '../api/createHumitureTimer.ts'
...
const { laboratoryOptions } = useLaboratoryOptionsHook({ isIotLab: 1, isAuth: 2 })
