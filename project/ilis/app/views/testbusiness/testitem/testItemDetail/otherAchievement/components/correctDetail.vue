...
const columns = [
  ...
  },
  {
    ...
    width: '15%',
    scopedSlots: { customRender: 'processProblemFileVos' },
  },
  {
    title: '提出人',
  ...
  },
  {
    ...
    width: '15%',
    scopedSlots: { customRender: 'isRecovered' },
  },
  {
    title: '修正人',
...
export default {
  components: {},
  props: ['businessId', 'changeSpinning'],
  data() {
    return {
      data: [],
      columns,
  ...
  methods: {
    ...
    getData(params) {
      ...
      window.$oAjax
        .get(window.$oApi.auditProcessRelation.getByBusinessList, {
          params: {
            page: -1,
            size: -1,
            businessType: 40,
            businessId: params || this.businessId,
          },
          headers: {
