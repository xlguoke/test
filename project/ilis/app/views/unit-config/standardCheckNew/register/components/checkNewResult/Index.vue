...
import { CHECKNEW_RECORD_STATUS, CHECKNEW_RECORD_STATUS_DICT, CheckNewResultEntity } from '.'
...
const initQuery = ref(CheckNewResultEntity.fromJSON({
  statuses: [CHECKNEW_RECORD_STATUS.UPDATED, CHECKNEW_RECORD_STATUS.DEPRECATED],
}))
...
function customReset() {
  initQuery.value.statuses = [CHECKNEW_RECORD_STATUS.UPDATED, CHECKNEW_RECORD_STATUS.DEPRECATED]
  customHandleSearch(initQuery.value)
}
