<template>
  ...
  >
    <div class="p-2">
      ...
      <p>1、下载查新信息导入模板，<a href="#" class="text-colorPrimary" @click="downloadTemplate">点击下载</a></p>
      <p>2、根据模板内容填写查新数据</p>
...
import type { RecordListParam } from '../api'
import type { IDialogPropsParam } from '~/anyThing/interface/IDialogProps'
import { message } from 'ant-design-vue'
import { importCheckNewResultApi, modalError } from '../api'
