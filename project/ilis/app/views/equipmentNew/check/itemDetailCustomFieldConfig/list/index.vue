  ...
  <div>
    <a-spin :spinning="spinning">
      <div class="spin-content">
        ...
        <CustomProperty :customize-type="type" />
        <!-- <a-table id="tableBox" :columns="columns" :pagination="false" :dataSource="data" -->
        <!-- bordered :customRow="customRow" rowKey="index" :rowClassName="rowClassName"> -->
        <!-- <template slot="operation" slot-scope="text, record"> -->
        <!-- &lt;!&ndash;:value="textNumber(text)"&ndash;&gt; -->
        <!-- <a-input-number v-if="record.processObjectId" type="number"  :value="text" -->
        <!-- @change="e => numberChange(e, record.processObjectId,'operation')" -->
        <!-- /> -->
