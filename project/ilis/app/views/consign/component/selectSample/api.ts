...
/** 将对象转为formData对象 */
function convertObj2FormData(obj: any) {
...
/** ## 校验批号的唯一性 */
export function checkBatchNumberUnique(value: string) {
  return IlisApiHelper.get<any>('testObjectController.do?uniqueSN', { value })
}
