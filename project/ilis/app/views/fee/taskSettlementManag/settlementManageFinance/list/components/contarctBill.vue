  ...
  >
    <div class="settlementApply" style="padding: 10px">
      <div class="from_wrap">
        ...
        <div v-if="type == 'contract'" class="input_box">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: '检测', dataIndex: 'testPersons' },
        { title: '协助人', dataIndex: 'helper' },
        { title: '复核', dataIndex: 'reviewPersons' },
        { title: '审核', dataIndex: 'auditPersons' },
        { title: '批准', dataIndex: 'approvePersons' },
