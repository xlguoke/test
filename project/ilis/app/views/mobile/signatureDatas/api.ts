 ...
 * # 上传文件：免登陆
 */
export function fileUploadNoLogin(base64: string, fileName: string) {
  return IlisApiHelper.postForm<Record<string, any>>('rest/sign/photo/upload', { base64, fileName }, setHearders())
}
