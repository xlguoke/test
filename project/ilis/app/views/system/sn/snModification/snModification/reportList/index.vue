          ...
          <div v-if="allSearch">
            <a-form style="width: 520px" :model="formState">
              <a-form-item
                ...
                :wrapper-col="{ span: 17 }"
              >
                <a-input v-model:value="formState.reportNumber" />
              </a-form-item>
              <a-form-item
                label="编号生成时间"
                :label-col="{ span: 5 }"
              ...
              <a-form-item
                ...
                :wrapper-col="{ span: 17 }"
              >
                <a-range-picker v-model:value="formState.testDates" value-format="YYYY-MM-DD" />
              </a-form-item>
              <a-form-item
                label="编号格式类型"
                :label-col="{ span: 5 }"
      ...
      <a-form>
        ...
        >
          <span class="form-item-span">
            {{ editData ? editData.reportNumber : '' }}
          </span>
        </a-form-item>
        <a-form-item
          label="新报告编号"
  ...
  methods: {
    ...
    getData(flag) {
      ...
      if (this.allSearch) {
        ...
        const testDatesValue = fieldsValue.testDates
        if (testDatesValue && testDatesValue.length > 0) {
          fieldsValue.testDates = `${testDatesValue[0]} ~ ${testDatesValue[1]}`
        }
        ...
        data = {
          ...fieldsValue,
          testDates: fieldsValue.testDates ? fieldsValue.testDates : '',
