<template>
  <a-modal
    ...
    :wrap-class-name="
      `ht-modal-wrap ${
        tiledLevel ? 'ht-modal-tiled-level' : ''} ${
        fixedHeight ? 'ht-modal-fixed-height' : ''} ${
        title ? '' : 'hide-title'} ${
        fullScreen ? 'ht-modal-full-screen' : ''}`
    "
...
const props = defineProps({
  ...
  /** 固定弹窗内容区域高度: 100vh - 180px */
  fixedHeight: Boolean,
  /** 全屏：全屏时，拖拽、固定内容区高度将不生效 */
  fullScreen: Boolean,
})

const emit = defineEmits(['update:open', 'cancel', 'ok'])

const disabledDrag = computed(() => !props.draggable || props.fullScreen)
...
.ht-modal-wrap.hide-title .ant-modal-header,
.ht-modal-wrap.hide-title .ant-modal-close{
  display: none !important;
}
.ant-modal-root .ht-modal-wrap.ht-modal-tiled-level {
  padding: 32px;
  right: initial;
  bottom: initial;
  left: 50%;
...
.ht-modal-wrap .ant-modal-content{
  padding: 16px;
}
...
.ht-modal-fixed-height .ant-modal-body{
  height: calc(100vh - 200px);
}
.ht-modal-fixed-height .ant-modal-body > .ant-spin-nested-loading,
.ht-modal-fixed-height .ant-modal-body > .ant-spin-nested-loading > .ant-spin-container{
  height: 100%;
}

.ht-modal-full-screen .ant-modal{
  width: 100% !important;
  max-width: 100% !important;
  height: 100% !important;
  top: 0;
}
.ht-modal-full-screen .ant-modal .ant-modal-content{
  height: 100vh;
  display: flex;
  flex-direction: column;
}
.ht-modal-full-screen .ant-modal .ant-modal-content .ant-modal-body{
  flex: 1;
  height: 0;
  max-height: inherit;
}
.ht-modal-full-screen .ant-modal-body > .ant-spin-nested-loading,
.ht-modal-full-screen .ant-modal-body > .ant-spin-nested-loading > .ant-spin-container{
  height: 100%;
}

.ht-modal-wrap .ant-modal-footer{
  margin-top: 4px;
  padding-top: 12px;
