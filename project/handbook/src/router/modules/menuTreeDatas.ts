...
const routeList: Array<RouteRecordRaw> = [
  ...
  },
  {
    path: '/udr/:type',
    name: 'Udr',
    component: () => import('@/views/udr/Index.vue'),
    meta: {
      title: 'UDR',
    },
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'SubmitReport',
        path: '/submitReport',
        component: () => import('@/views/testTask/components/SubmitReport/SubmitReportPage.vue'),
        children: [],
        meta: {
          title: '提交报告',
          icon: '',
      ...
      },
      {
        ...
        component: () => import('@/views/testTask/components/TaskReportDetail.vue'),
        children: [],
        meta: {
          title: '报告详情',
          icon: '',
      ...
      {
        name: 'TestTaskDetailPC',
        path: '/testTaskDetailPC',
        component: () => import('@/views/testTask/components/TestTaskDetailPC.vue'),
        children: [],
        meta: {
          title: '任务详情',
          icon: '',
