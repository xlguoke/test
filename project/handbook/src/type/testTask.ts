...
export const onlineTaskList = z
  .object({
    ...
    paramsName: z.string(),
    testRecordCode: z.string().nullable(),
    testObjectCode: z.string().nullable(),
    testTaskCode: z.string().nullable(),
    testTaskId: z.string(),
...
// 上传json数据集
const recordJsonValues = z.object({
  value: z.string(),
  groupKey: z.string(),
})
...
const uploadOfflineDataDTO = z.object({
  ...
  recordJsonValues: z.array(recordJsonValues),
  modifyLogDetail: z.array(recordJsonValues).nullable(),
  notes: z.array(recordJsonValues).nullable(),
