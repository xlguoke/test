        ...
        >
          ...
          <a-col :span="12">
            <a-form-item
              label="试验室类型"
              name="type"
              :rules="[{ required: true, message: '选择试验室类型!' }]"
            >
              <a-select
                ref="select"
                v-model:value="baseLaboratoryForm.type"
                :disabled="props.details"
                placeholder="选择试验室类型"
              >
          ...
          <a-col :span="12">
            <a-form-item
              label="占地总面积"
              name="floorArea"
              :rules="[{ required: true, message: '请输入占地总面积!' }]"
            >
              <a-input
                v-model:value="baseLaboratoryForm.floorArea"
                :disabled="props.details"
