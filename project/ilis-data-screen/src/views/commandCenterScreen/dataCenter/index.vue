  ...
  <div class="data-center">
    <Niceframe class="h-[19%]" top-line>
      <div class="flex justify-around items-center w-full h-full">
        ...
        >
          <template #icon>
            <img class="w-88" src="@/assets/images/commandCenterScreen/test-icon-1.svg" />
          </template>
        ...
        >
          <template #icon>
            <img class="w-88" src="@/assets/images/commandCenterScreen/test-icon-2.svg" />
          </template>
        ...
        >
          <template #icon>
            <img class="w-88" src="@/assets/images/commandCenterScreen/test-icon-3.svg" />
          </template>
        ...
        >
          <template #icon>
            <img class="w-88" src="@/assets/images/commandCenterScreen/test-icon-4.svg" />
          </template>
    ...
    <div class="data-center-center h-[37%]">
      <Niceframe class="w-480 h-full" title="样品数量统计">
        <div class="flex relative flex-wrap px-32 pt-32 w-full h-full">
          ...
          <SampleCount title="全部样品">
            <template #icon>
              <img class="w-80" src="@/assets/images/commandCenterScreen/sample-icon-1.svg" />
            </template>
            <NumberScroll :value="sampleProcessStatistics.total" />
          </SampleCount>
          <SampleCount title="在检样品" class="justify-end">
            <template #icon>
              <img class="w-80" src="@/assets/images/commandCenterScreen/sample-icon-2.svg" />
            </template>
            <NumberScroll :value="sampleProcessStatistics.testing" />
          </SampleCount>
          <SampleCount title="留样样品">
            <template #icon>
              <img class="w-80" src="@/assets/images/commandCenterScreen/sample-icon-3.svg" />
            </template>
            <NumberScroll :value="sampleProcessStatistics.keep" />
          </SampleCount>
          <SampleCount title="待检样品" class="justify-end">
            <template #icon>
              <img class="w-80" src="@/assets/images/commandCenterScreen/sample-icon-4.svg" />
            </template>
            <NumberScroll :value="sampleProcessStatistics.wait" />
          </SampleCount>
        </div>
      </Niceframe>
      <Niceframe class="w-420 h-full" title="委托单位委托任务数量统计">
      ...
      <Niceframe class="w-420 h-full" title="部门出具报告统计">
        <div class="relative h-full">
      ...
      <Niceframe class="w-480 h-full" title="人员出具报告统计">
        <div class="relative h-full">
    ...
    <div class="data-center-bottom h-[43%]">
      <Niceframe class="w-480 h-full" title="委托任务类型排行">
      ...
      <Niceframe class="flex-1 h-full w-0" title="检测任务统计" long-title>
        <div class="relative h-full">
      ...
      <Niceframe class="w-480 h-full" title="高频设备使用次数">
        <div class="relative h-full overflow-hidden">
