...
export class EditHumitureRecordEntity {
  /**
   * 湿度
   */
  hum?: number
...
/** 新增 巡查 */
export function editHumitureRecord(id: string, data: EditHumitureRecordEntity) {
  return IlisApiHelper.put<IResponseCommonEntity<any>>(`rest/humiture/record/${id}`, data)
}
