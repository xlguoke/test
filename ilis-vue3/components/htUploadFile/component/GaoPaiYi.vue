    ...
    <div class="gpy-head">
      <a-form :model="form" layout="inline">
        ...
        <!-- <a-form-item label="扫描模式">
          <a-select v-model:value="form.scanMode" :disabled="!openSuccess" placeholder="请选择">
    ...
    <div class="gpy-body">
      ...
      <div class="gpy-side">
        ...
        <div class="gpy-side-content">
          <a-checkbox-group v-model:value="selectedFileIds" style="width: 100%">
...
function initControl() {
  ...
  window.Cam_ControlInit(dom, camW.value, camH.value, gpyCB)
}
...
async function createFileInfo() {
  ...
  if (form.customName && form.fileType !== 3) {
    fileName = await AnyDialogHelper.showModel(CustomName, { name: fileName, fileType: type })
  }
  const filePath = `${fileFolder.value}${fileName}.${type}`
